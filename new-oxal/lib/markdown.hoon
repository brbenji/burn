          ...
          ++  inline       :: Inline elements
            |%
              ...
              ++  autolink
                ...
                %+  stag  %autolink
                %+  cook  crip
                ;~(plug ;~(pose (jest 'https://') (jest 'http://')) (plus ;~(less ace prn)))
                ::
                :: i have commented out this triangle stuff because
                :: i wanted raw links to work and who even knows about
                :: angle brackets in markdown... it's wack.
                ::
        ...
        =>  |%
              ++  get-direct-link  :: DUPE: get-direct-link
                ...
                ?-  -.target
                  ...
                  %ref                                          :: Ref link; look it up
                    :: ~|  "reflink not found: {<label.target>}"
                    %+  ~(gut by reference-links)  label.target
                    [['' %.n] `label.target]
                ==
            --
        |%
          ...
          ++  element
            ...
            ?-  -.e
              ...
              %image  (image e)
              %autolink  (autolink e)
              :: %html  ;/  ""  :: option to avoid css
              %html
                =/  m=manx  (html e)
                m(a.g [raw-html+"" a.g.m])
            ==
          ++  html
            |=  [h=html:inline:m]
            ^-  manx
          ...
          ++  user
            |=  [u=user:inline:m]
            ^-  manx
            ;span(itemprop "ship"):(-(scow %p ship.u))
          ++  text
            |=  [t=text:inline:m]
            ^-  manx
          ...
          ++  link
            ...
            ;a(href (trip text.url.urlt), target "_blank", title (trip (fall title-text.urlt '')))
              ;*  (contents contents.l)
            ==
          ++  image
            |=  [i=image:inline:m]
          ...
          ++  autolink
            |=  [a=autolink:inline:m]
            ^-  manx
            ;a(href (trip text.a), target "_blank"): {(trip text.a)}
          ++  emphasis
            |=  [e=emphasis:inline:m]
            ^-  manx
            ;em
